        ...
        <header class="max-w-4xl mx-auto px-6 pb-10">
            ...
            <div class="sm:flex items-center justify-between space-x-4">
                <div class="sm:w-1/3 mb-8 sm:mb-0">
                    ...
                    <p class="text-xs font-extralight">Improving quickteller</p>
                </div>
        ...
        <main class="max-w-4xl mx-auto px-6 py-20">
            <section class="sm:flex sm:space-x-12">
                ...
                <div class="font-extralight leading-loose">
                    ...
                    <p>I use quickteller. A lot. To send money, to buy airtime and to pay for my internet plan. Before the quickteller interface redesign, it was hard to admire the interface. I wanted to logout as quickly as I logged in. But after the interface redesign, it was easier to look at. I’ve always wanted to use Quickteller as a case study. Today I have. I did a research to improve Quickteller’s landing page and overall UX. </p>
                </div>
            </section>
            <section class="py-20">
            ...
            <section class="py-10 leading-loose">
                ...
                <ul class="mb-8 list-disc list-inside">
                    <li class="px-3 mb-1">Platform features is not clear enough.</li>
                    <li class="px-3 mb-1">The use of the images in the background give the platform an outdated look</li>
                    <li class="px-3 mb-1">There is no indication on the landing page that the platofrm has a mobile application</li>
                </ul>
                <p class="mb-8">Seeing as more people use mobile devices to perform such tasks, there ought to be an indication od a
            ...
            <section class="py-10 leading-loose">
                ...
                <div>
                    <h3 class="text-base font-semibold mb-2">Pain points 1,2,3 addressed</h3>
                    <ul class="mb-8 list-disc list-inside">
                        <li class="mb-1 px-3">Take out the side menu and use cards.</li>
                        <li class="mb-1 px-3">Each feature on the platform is represented as a card</li>
                        <li class="mb-1 px-3">Add section indication that there is a mobile application available</li>
                        <li class="mb-1 px-3">Changed the main background image to give the platform a more modern look.</li>
                    </ul>
