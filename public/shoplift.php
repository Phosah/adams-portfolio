...
<body class="font-normal font-body text-sm">
    <div class="bg-brand-black-light text-white">
        <header class="max-w-4xl mx-auto px-6 pb-14">
            <?php include 'navbar.php' ?>
            <div class="sm:flex items-center justify-between space-x-12">
                <div class="sm:w-1/3 mb-8 sm:mb-0">
                    <div class="mb-8 font-extralight">
                        <p>Onepage E-Commerce</p>
                        <p>Web UI Design</p>
                    </div>
                    <div class="mb-8">
                ...
                <div class=""><img src="img/shoplift.png" alt="Shoplift"></div>
            </div>
        </header>
    </div>
    <div class="bg-brand-black-lighter text-white">
        <main class="max-w-4xl mx-auto px-6">
            <section class="sm:flex sm:space-x-12 py-20">
                ...
                <div class="font-extralight leading-loose">
                    ...
                    <p class="">Trying to search for a particular style or design over here in our community has left our culture in regards to online vendors (e-commerce mainstream) where you can buy anything you want but then the essence to taste in fashion is based on the idea to a particular type of style.</p>
                    <p class="mb-8">The information as to fashion hub website in our community does not work, hence online vendors which only showcase different style/trend without proper catalogue of a particular brand/fashion style which can be difficult to navigate; as such, I took this personal project as my first step into UI Design.</p>
                    <p class="mb-8">Although, it is a one page design and showcase a landing page feature of what the website does before you get the actual content which as a user must be signed in to access other features or products the website has to offer.</p>
            ...
            <section class="p-12 bg-brand-black-light">
                <div class="flex items-center space-x-4 mb-4">
                    ...
                    <p class="text-lg font-semibold">Nigeria</p>
                </div>
            ...
            <section class="py-14">
                <h2 class="mb-6 inline-block border-b-2 border-brand-orange-lighter text-lg font-semibold">Ideation</h2>
                <h3 class="text-base font-semibold mb-4">a. User Story</h3>
                <p class="mb-8 leading-loose">For my design solution, the key experience is the “Style/Design Catolgue”. This is also the least viable feature the product can offer, other features on accessing the e-commerce function is also included in the design setup.</p>
                ...
                <h3 class="mb-4 text-base font-semibold">b. Wireframing</h3>
                <p class="leading-loose">Once I got an understanding of the users, their task and stories, I started sketching design solutions. The process of sketching enables me to visualize different ideas and try out content placement.</p>
            </section>
            <section class="py-14 leading-loose">
                ...
                <p class="mb-14">The mood and emotions to be evoked from the application are those of calm, trendy, elegant, bold and overall uniqueness. As a UI Designer, I can translate these type of colors in unique ways. </p>
                <div class="flex flex-wrap justify-between mb-14 py-10 px-8 bg-brand-black-light">
                    <div class="mx-1">
                ...
                <div class="mb-8">
                    <h3 class="text-base font-semibold mb-4">Hi-Fidelity Mockups</h3>
                    <p>For the look and feel I wanted the website to mirror the look and feel of an e-commerce but maintian the fashion catalogue outlook which is predominantly white in colour. For this project, I made it a personal thing as it was my journey into the world of design for the first time.</p>
                </div>
                <div class="flex items-center space-x-2 mb-8">
                    <div><img src="img/shoplift-home.png" alt="Shoplift homepage"></div>
                    <div><img src="img/shoplift-1.png" alt="Shoplift"></div>
                </div>
                <div class="mb-8">
                    <h3 class="text-base font-semibold mb-3">Learnings</h3>
                    <p>I found this project refreshing as it opened up my mind to different approaches to design process. The key learning for me was seeing the transition of how design can be formed and shaped into information. Found out that proper research, design thinking, and design methodology can help help modulate your workflow or thought process.</p>
                </div>
                <div>
                    <h3 class="text-base font-semibold mb-3">Next Steps</h3>
            ...
            <section class="pt-14 pb-28">
                <div class="max-w-xl mx-auto flex items-center justify-between space-x-6">
                    ...
                    <div><img src="img/mobileget-1.png" alt="Cash Exchange"></div>
                </div>
            </section>
        </main>
